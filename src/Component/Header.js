                ...
                <header id="header">
                    <div className="d-flex flex-column">              
                        ...
                        <nav className="nav-menu">
                            <ul>
                                <Scrollspy items={ ['hero','about', 'skills','resume', 'portfolio','services','contact'] } currentClassName="active">
                                    ...
                                    <li><a href="#skills"><i className="bx bx-user"></i> <span>Skills</span></a></li>
